...
所有的代码文件（除了 `Sudoku.Recognition` 项目以外），全部使用的是 MIT 开源协议。MIT 开源协议意味着你需要在你的应用程序里声明本项目的作者信息。

然后，`Sudoku.Recognition` 项目是唯一一个使用了别的开源代码的项目。这个项目遵守的是 LGPL v2.1 开源协议。详情请查看那个项目的代码提供的开源协议文件。
