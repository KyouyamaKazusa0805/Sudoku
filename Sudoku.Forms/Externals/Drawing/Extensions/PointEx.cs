...
namespace Sudoku.Drawing.Extensions
{
	...
	public static class PointEx
	{
		...
		public static WPoint ToWPoint(this DPoint @this) =>
			new WPoint(@this.X, @this.Y);
		...
		/// <param name="this">(<see langword="this"/> parameter) The point to convert.</param>
		/// <returns>The result of conversion.</returns>
		public static DPoint ToDPoint(this WPoint @this) =>
			new DPoint((int)@this.X, (int)@this.Y);
		...
		/// <param name="this">(<see langword="this"/> parameter) The point to convert.</param>
		/// <returns>The result of conversion.</returns>
		public static DPointF ToDPointF(this WPoint @this) =>
			new DPointF((float)@this.X, (float)@this.Y);
		...
		public static WPoint Truncate(this WPoint @this) =>
			new WPoint((int)@this.X, (int)@this.Y);
	}
}
