...
namespace Sudoku.Solving.Locked
{
	...
	{
		public LockedInfo(
			Conclusion conclusion, ICollection<View> views, int digit, Region baseSet, Region coverSet)
		...
		public override decimal Difficulty =>
			BaseSet.RegionType == RegionType.Block ? 2.6m : 2.8m;

		public int Digit { get; }

		public override string Name =>
			BaseSet.RegionType == RegionType.Block ? "Pointing" : "Claiming";
		...
		public override string ToString() =>
			$@"{Name}: {Digit + 1} in {BaseSet}\{CoverSet} => {Conclusion}";
	}
}
