...
{
	/// <summary>
	/// Indicates the detail data of XR type 3.
	/// </summary>
	public sealed class ExtendedRectangleType3DetailData : ExtendedRectangleDetailData
	{
		/// <summary>
		...
		public ExtendedRectangleType3DetailData(
