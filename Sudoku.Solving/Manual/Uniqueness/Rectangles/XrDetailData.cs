...
{
	/// <summary>
	/// Provides all data for extended rectangles (basic and extended types).
	/// </summary>
	public abstract class XrDetailData : IRectangleDetailData
	{
		/// <summary>
		...
		protected XrDetailData(IReadOnlyList<int> cells, IReadOnlyList<int> digits) =>
