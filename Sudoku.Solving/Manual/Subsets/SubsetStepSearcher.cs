...
namespace Sudoku.Solving.Manual.Subsets
{
	...
	public sealed class SubsetStepSearcher : StepSearcher
	{
		...
		private static void GetHiddenSubsets(IList<StepInfo> accumulator, in SudokuGrid grid, int size)
		{
		...
		/// <param name="grid">(<see langword="in"/> parameter) The grid.</param>
		/// <param name="size">The size to search.</param>
		private static void GetNakedSubsets(IList<StepInfo> accumulator, in SudokuGrid grid, int size)
		{
			for (int region = 0; region < 27; region++)
			{
