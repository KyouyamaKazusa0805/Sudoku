...
namespace Sudoku.Solving.Manual.Exocets
{
	...
	{
		/// <inheritdoc/>
		public SeTechniqueSearcher(bool checkAdvanced) : base(checkAdvanced)
		{
		}


		/// <inheritdoc cref="SearchingProperties"/>
		public static TechniqueProperties Properties { get; } = new(96, nameof(TechniqueCode.Se)) { DisplayLevel = 4 };
