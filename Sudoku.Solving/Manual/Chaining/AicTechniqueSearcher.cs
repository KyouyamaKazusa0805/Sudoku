...
namespace Sudoku.Solving.Manual.Chaining
{
	...
	public sealed class AicTechniqueSearcher : ChainTechniqueSearcher
	{
		...
		private void SumUpResult(
			IBag<TechniqueInfo> accumulator, AicTechniqueInfo resultInfo)
		{
			if (_onlySaveShortestPathAic)
			{
				...
				{
					if (accumulator[i] is AicTechniqueInfo comparer
						&& comparer == resultInfo)
					{
						hasSameAic = true;
						sameAicIndex = i;
		...
		private Action<AicTechniqueInfo> GetAct(IBag<TechniqueInfo> accumulator)
		{
