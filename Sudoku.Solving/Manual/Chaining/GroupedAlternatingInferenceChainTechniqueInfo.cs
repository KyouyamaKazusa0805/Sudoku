...
{
	/// <summary>
	/// Provides a usage of (grouped) alternating inference chain (AIC) technique.
	/// </summary>
	[SuppressMessage("", "CS0660")]
	public sealed class GroupedAlternatingInferenceChainTechniqueInfo : ChainTechniqueInfo
	{
		/// <summary>
		...
		/// </param>
		public GroupedAlternatingInferenceChainTechniqueInfo(
		...
		public override bool Equals(TechniqueInfo obj) =>
			obj is GroupedAlternatingInferenceChainTechniqueInfo comparer && Equals(comparer);

		/// <inheritdoc/>
		public bool Equals(GroupedAlternatingInferenceChainTechniqueInfo other)
		{
			if (IsContinuousNiceLoop)
			{
				...
				{
					thisMap.AddRange(Nodes[i].GetCandidates());
					otherMap.AddRange(other.Nodes[i].GetCandidates());
				}
		...
		public static bool operator ==(
			GroupedAlternatingInferenceChainTechniqueInfo left,
			GroupedAlternatingInferenceChainTechniqueInfo right) =>
			left.Equals(right);
