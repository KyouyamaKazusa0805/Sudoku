...
{
	var grid = Sudoku.Data.SudokuGrid.Parse("58090000100008570000000100047+30+9012000010400+7+156000+4890004000000+496300+10200009074:255 577 578 579 192 597 897");
...
{
	var grid = Sudoku.Data.SudokuGrid.Parse("580900001000085700000001000470000120000104000056000089000400000009630000200009074");
...
#if SOLVE_PUZZLE_BY_LOGICAL_TECHNIQUES || true
{
	...
	{
		var grid = Sudoku.Data.SudokuGrid.Parse(text);
