namespace Sudoku
{
	...
	/// </summary>
	public static class GridProcessings
	{
		/// <summary>
		/// <para>Indicates a table for each cell's peers.</para>
		/// <para>
		/// I strongly recommend that you <b>should not</b> modify any values in this array.
		/// </para>
		/// </summary>
		/// <example>
		...
		/// The indices is between 0 and 26, where 0..9 is for block 1 to 9,
		/// 9..18 is for row 1 to 9 and 18..27 is for column 1 to 9.
		/// </para>
		/// <para>
		/// I strongly recommend that you <b>should not</b> modify any values in this array.
		/// </para>
