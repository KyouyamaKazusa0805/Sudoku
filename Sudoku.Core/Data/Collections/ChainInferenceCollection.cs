...
namespace Sudoku.Data.Collections
{
	...
	public readonly ref struct ChainInferenceCollection
	{
		...
		public ChainInferenceCollection(Span<ChainInference> collection) => _collection = collection;

		/// <summary>
		/// Initializes an instance with the specified collection.
		/// </summary>
		/// <param name="collection">The collection.</param>
		public ChainInferenceCollection(IEnumerable<ChainInference> collection) => _collection = collection.ToArray().AsSpan();
