...
internal static class IPropertyReferenceOperationExtensions
{
	/// <summary>
	...
	public static bool SameReferenceWith(this IPropertyReferenceOperation @this, IPropertyReferenceOperation other)
	{
