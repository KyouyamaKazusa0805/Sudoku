...
| SCA0013       | SourceGen | Error    | For the consideration on encapsulation, the field marked '[PropertyAutoNotify]' cannot be pointer types |                                                              |
| SCA0014       | SourceGen | Error    | The identifier of the field should start with underline and be applied camel-casing style |                                                              |
| SCA0015       | SourceGen | Error    | The type should be partial type if any field is marked '[PropertyAutoNotify]' |                                                              |
| SCA0016       | SourceGen | Error    | The containing type of the field marked '[PropertyAutoNotify]' cannot be generic one |                                                              |
| SCA0017       | SourceGen | Error    | The containing type of the field marked '[PropertyAutoNotify]' must derive from 'NotificationObject' |                                                              |
| SCA0018       | SourceGen | Error    | The field cannot be modified 'static' if it is marked '[PropertyAutoNotify]' |                                                              |
| SCA0019       | SourceGen | Error    | The field cannot be modified 'readonly' if it is marked '[PropertyAutoNotify]' |                                                              |
