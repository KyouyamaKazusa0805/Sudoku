...
/// </list>
/// </summary>
public sealed partial class UniqueRectangleStepSearcher : IStepSearcher
{
	/// <summary>
	...
	private void GetAll(ICollection<UniqueRectangleStep> gathered, in Grid grid, bool arMode)
	{
		...
		for (int index = 0, l = Patterns.Length; index < l; index++)
		{
			...
			for (int i = 0, length = allDigitsInThem.Length, iterationLength = length - 1; i < iterationLength; i++)
			{
						...
						for (int c2 = c1 + 1; c2 < 4; c2++)
						{
							...
							switch ((A: c1, B: c2))
							{
								...
								case (A: 1, B: 2): // Diagonal type.
								{
									...
									{
										// Don't merge into the else-if block.
										// Here the methods may be extended.
										if (SearchForExtendedUniqueRectangles)
										{
	...
	#region Partial declarations
	partial void CheckType1(ICollection<UniqueRectangleStep> accumulator, in Grid grid, int[] urCells, bool arMode, short comparer, int d1, int d2, int cornerCell, in Cells otherCellsMap, int index);
	partial void CheckType2(ICollection<UniqueRectangleStep> accumulator, in Grid grid, int[] urCells, bool arMode, short comparer, int d1, int d2, int corner1, int corner2, in Cells otherCellsMap, int index);
	partial void CheckType3Naked(ICollection<UniqueRectangleStep> accumulator, in Grid grid, int[] urCells, bool arMode, short comparer, int d1, int d2, int corner1, int corner2, in Cells otherCellsMap, int index);
	partial void CheckType3Hidden(ICollection<UniqueRectangleStep> accumulator, in Grid grid, int[] urCells, bool arMode, short comparer, int d1, int d2, int corner1, int corner2, in Cells otherCellsMap, int index);
	partial void CheckType4(ICollection<UniqueRectangleStep> accumulator, in Grid grid, int[] urCells, bool arMode, short comparer, int d1, int d2, int corner1, int corner2, in Cells otherCellsMap, int index);
	partial void CheckType5(ICollection<UniqueRectangleStep> accumulator, in Grid grid, int[] urCells, bool arMode, short comparer, int d1, int d2, int cornerCell, in Cells otherCellsMap, int index);
	partial void CheckType6(ICollection<UniqueRectangleStep> accumulator, in Grid grid, int[] urCells, bool arMode, short comparer, int d1, int d2, int corner1, int corner2, in Cells otherCellsMap, int index);
	partial void CheckHidden(ICollection<UniqueRectangleStep> accumulator, in Grid grid, int[] urCells, bool arMode, short comparer, int d1, int d2, int cornerCell, in Cells otherCellsMap, int index);
	partial void Check2D(ICollection<UniqueRectangleStep> accumulator, in Grid grid, int[] urCells, bool arMode, short comparer, int d1, int d2, int corner1, int corner2, in Cells otherCellsMap, int index);
	partial void Check2B1SL(ICollection<UniqueRectangleStep> accumulator, in Grid grid, int[] urCells, bool arMode, short comparer, int d1, int d2, int corner1, int corner2, in Cells otherCellsMap, int index);
	partial void Check2D1SL(ICollection<UniqueRectangleStep> accumulator, in Grid grid, int[] urCells, bool arMode, short comparer, int d1, int d2, int corner1, int corner2, in Cells otherCellsMap, int index);
	partial void Check3X(ICollection<UniqueRectangleStep> accumulator, in Grid grid, int[] urCells, bool arMode, short comparer, int d1, int d2, int cornerCell, in Cells otherCellsMap, int index);
	partial void Check3X2SL(ICollection<UniqueRectangleStep> accumulator, in Grid grid, int[] urCells, bool arMode, short comparer, int d1, int d2, int cornerCell, in Cells otherCellsMap, int index);
	partial void Check3N2SL(ICollection<UniqueRectangleStep> accumulator, in Grid grid, int[] urCells, bool arMode, short comparer, int d1, int d2, int cornerCell, in Cells otherCellsMap, int index);
	partial void Check3U2SL(ICollection<UniqueRectangleStep> accumulator, in Grid grid, int[] urCells, bool arMode, short comparer, int d1, int d2, int cornerCell, in Cells otherCellsMap, int index);
	partial void Check3E2SL(ICollection<UniqueRectangleStep> accumulator, in Grid grid, int[] urCells, bool arMode, short comparer, int d1, int d2, int cornerCell, in Cells otherCellsMap, int index);
	partial void Check4X3SL(ICollection<UniqueRectangleStep> accumulator, in Grid grid, int[] urCells, bool arMode, short comparer, int d1, int d2, int corner1, int corner2, in Cells otherCellsMap, int index);
	partial void Check4C3SL(ICollection<UniqueRectangleStep> accumulator, in Grid grid, int[] urCells, bool arMode, short comparer, int d1, int d2, int corner1, int corner2, in Cells otherCellsMap, int index);
	partial void CheckWing(ICollection<UniqueRectangleStep> accumulator, in Grid grid, int[] urCells, bool arMode, short comparer, int d1, int d2, int corner1, int corner2, in Cells otherCellsMap, int size, int index);
	partial void CheckSdc(ICollection<UniqueRectangleStep> accumulator, in Grid grid, int[] urCells, bool arMode, short comparer, int d1, int d2, int corner1, int corner2, in Cells otherCellsMap, int index);
	partial void CheckUnknownCoveringUnique(ICollection<UniqueRectangleStep> accumulator, in Grid grid, int[] urCells, short comparer, int d1, int d2, int index);
	partial void CheckGuardianUnique(ICollection<UniqueRectangleStep> accumulator, in Grid grid, int[] urCells, short comparer, int d1, int d2, int index);
	partial void CheckGuardianAvoidable(ICollection<UniqueRectangleStep> accumulator, in Grid grid, int[] urCells, short comparer, int d1, int d2, int index);
	partial void CheckHiddenSingleAvoidable(ICollection<UniqueRectangleStep> accumulator, in Grid grid, int[] urCells, int d1, int d2, int corner1, int corner2, in Cells otherCellsMap, int index);
	#endregion
