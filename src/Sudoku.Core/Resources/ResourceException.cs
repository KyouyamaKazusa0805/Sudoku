...
public abstract partial class ResourceException([PrimaryCosntructorParameter(MemberKinds.Field, Accessibility = "protected readonly")] Assembly? assembly) : Exception
{
	/// <inheritdoc/>
