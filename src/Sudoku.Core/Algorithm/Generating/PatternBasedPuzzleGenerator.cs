	...
	IPuzzleGenerator
{
	...
	public PatternBasedPuzzleGenerator() : this(null!, null)
	{
	}
	...
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public PatternBasedPuzzleGenerator(scoped in CellMap pattern) : this(pattern, null)
	{
	}
	...
	private void AdjustPattern(scoped ref CellMap pattern)
	{
		...
		pattern -= GetCells(cellToBeDeleted / 9, cellToBeDeleted % 9);
