...
public sealed partial class IntersectionCollection([PrimaryCosntructorParameter(MemberKinds.Field, Accessibility = "internal readonly")] Intersection[] values) : IEnumerable<Intersection>
{
	/// <summary>
