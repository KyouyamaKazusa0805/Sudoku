...
partial struct Grid
{
	...
	public ref struct CandidateEnumerator(ref Mask arr)
	{
		/// <summary>
		...
		/// </summary>
		public readonly Candidate Current => _currentIndex * 9 + TrailingZeroCount(_currentMask);
		...
		public bool MoveNext()
		{
			...
			{
				_currentIndex++;
				if (MaskToCellState(AddByteOffset(ref _start, _currentIndex)) == CellState.Empty)
				{
					break;
				}
			}
