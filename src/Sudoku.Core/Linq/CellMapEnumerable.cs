...
public static class CellMapEnumerable
{
	...
	public static Cell First(this scoped ref readonly CellMap @this, Func<Cell, bool> match) => @this.FirstOrNull(match)!.Value;
	...
	/// <exception cref="InvalidOperationException">Throws when no elements found.</exception>
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public static Cell First(this scoped ref readonly CellMap @this, ref readonly Grid grid, CellMapPredicate match)
	...
	/// <param name="match">The condition to be used.</param>
	/// <returns>The first found cell.</returns>
	public static Cell? FirstOrNull(this scoped ref readonly CellMap @this, ref readonly Grid grid, CellMapPredicate match)
	{
		foreach (var cell in @this.Offsets)
		{
