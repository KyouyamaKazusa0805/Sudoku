...
public static class CandidateMapEnumerable
{
	...
	/// <param name="match">The condition to be used.</param>
	/// <returns>The first found candidate.</returns>
	public static Candidate? FirstOrNull(this in CandidateMap @this, Func<Candidate, bool> match)
	{
	...
	/// <param name="match">The condition to be used.</param>
	/// <returns>The first found candidate.</returns>
	public static Candidate? FirstOrNull(this in CandidateMap @this, ref readonly Grid grid, CandidateMapPredicate match)
	{
		foreach (var candidate in @this.Offsets)
		{
	...
	public static ReadOnlySpan<TResult> Select<TResult>(this in CandidateMap @this, Func<Candidate, TResult> selector)
	{
