...
public abstract partial class RuntimeAnalyticsException([PrimaryConstructorParameter(GeneratedMemberName = "InvalidGrid")] scoped ref readonly Grid grid) : Exception
{
	/// <inheritdoc/>
