...
/// <see cref="IAnalyzer{TSolver, TSolverResult}.Analyze(in Grid, IProgress{AnalyzerProgress}, CancellationToken)"/>.
/// </summary>
/// <typeparam name="TSolver">The solver's type.</typeparam>
/// <typeparam name="TSelf">The type of the target result itself.</typeparam>
/// <seealso cref="IAnalyzer{TSolver, TSolverResult}.Analyze(in Grid, IProgress{AnalyzerProgress}, CancellationToken)"/>
