...
/// <see cref="IAnalyzer{TSelf, TResult}.Analyze(ref readonly Grid, IProgress{AnalyzerProgress}?, CancellationToken)"/>.
/// </summary>
/// <param name="StepSearcherName">Indicates the currently used step searcher.</param>
/// <param name="Percent">The percent value.</param>
/// <seealso cref="IAnalyzer{TSelf, TResult}.Analyze(ref readonly Grid, IProgress{AnalyzerProgress}?, CancellationToken)"/>
