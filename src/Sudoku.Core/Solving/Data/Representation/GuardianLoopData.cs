...
/// <param name="HousesMask">Indicates the houses used in this pattern, specified as a mask.</param>
public readonly record struct GuardianLoopData(scoped in Cells Loop, scoped in Cells Guardians, int HousesMask);
