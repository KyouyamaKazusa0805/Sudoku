...
public static class GridMinLexComparisonExtensions
{
	...
	public static bool Equals(this scoped ref readonly Grid @this, ref readonly Grid other, GridComparison comparisonType)
	...
	/// <exception cref="ArgumentOutOfRangeException">Throws when the argument <paramref name="comparisonType"/> is not defined.</exception>
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public static int CompareTo(this scoped ref readonly Grid @this, ref readonly Grid other, GridComparison comparisonType)
