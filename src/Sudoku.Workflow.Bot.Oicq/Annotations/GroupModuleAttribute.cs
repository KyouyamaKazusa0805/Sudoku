...
public sealed class GroupModuleAttribute : CommandLineAnnotationAttribute
{
	/// <summary>
	/// 实例化一个 <see cref="GroupModuleAttribute"/> 类型的实例，并给出其模块触发的名称。
	/// </summary>
	/// <param name="name">触发名称。</param>
	public GroupModuleAttribute(string name) => Name = name;

	/// <summary>
	/// 实例化一个 <see cref="GroupModuleAttribute"/> 类型的实例，无需名称。
	/// </summary>
