...
partial class DrawingElementBag
{
	...
	public ref struct OfTypeEnumerator<T1, T2> where T1 : DrawingElement where T2 : DrawingElement
	{
		/// <summary>
		...
		/// <summary>
		/// Initializes an <see cref="OfTypeEnumerator{T1, T2}"/> instance via the details.
		/// </summary>
