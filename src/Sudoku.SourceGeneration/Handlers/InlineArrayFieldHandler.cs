...
{
	public static InlineArrayFieldCollectedResult? Transform(GeneratorAttributeSyntaxContext gasc, CancellationToken _)
	{
		if (gasc is not
			{
				Attributes: [
	...
	public static void Output(SourceProductionContext spc, ImmutableArray<InlineArrayFieldCollectedResult> value)
		=> spc.AddSource(
