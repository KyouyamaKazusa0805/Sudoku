...
public readonly record struct CrosshatchingInfo(scoped ref readonly CellMap BaseCells, scoped ref readonly CellMap EmptyCells, scoped ref readonly CellMap ExcludedCells);
