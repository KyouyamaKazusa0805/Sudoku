...
internal readonly record struct IntersectionResult(scoped ref readonly CellMap LineMap, scoped ref readonly CellMap BlockMap, scoped ref readonly CellMap IntersectionMap, byte[] OtherBlocks);
