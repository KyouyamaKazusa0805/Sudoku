...
public abstract partial class UnaryExpressionBase([PrimaryCosntructorParameter(MemberKinds.Field, Accessibility = "protected")] IExpression expression) : IExpression
{
	/// <inheritdoc/>
