...
/// For example, Deadly Patterns is unavailable for Sukaku puzzles because we cannot determine
...
public sealed class PartiallyNotSupportedAttribute(PartiallyUnavailableCase cases) : StepSearcherMetadataAttribute
{
	/// <summary>
	/// Indicates the cases that the current <see cref="StepSearcher"/> instance cannot be running on.
	/// </summary>
	public PartiallyUnavailableCase Cases { get; } = cases;
}
