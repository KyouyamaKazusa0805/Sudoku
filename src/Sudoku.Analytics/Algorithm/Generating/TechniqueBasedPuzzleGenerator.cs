...
public abstract class TechniqueBasedPuzzleGenerator
{
	...
	public abstract bool TryGenerateOnlyOneCell(out Grid result, CancellationToken cancellationToken);
	...
	public abstract bool TryGenerateUnique(out Grid result, CancellationToken cancellationToken);
