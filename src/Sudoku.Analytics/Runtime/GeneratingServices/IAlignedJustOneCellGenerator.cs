...
public interface IAlignedJustOneCellGenerator
{
	...
	/// </summary>
	/// <param name="alignment">The target alignment to be checked.</param>
	...
	public abstract Grid GenerateJustOneCell(ConclusionCellAlignment alignment, out Step? step, CancellationToken cancellationToken = default);
