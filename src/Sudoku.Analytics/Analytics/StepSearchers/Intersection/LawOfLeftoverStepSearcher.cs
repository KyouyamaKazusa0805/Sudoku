...
/// </list>
/// </summary>
[StepSearcher(Technique.LawOfLeftover, Flags = ConditionalFlags.DirectTechniquesOnly)]
			...
			var step = new LawOfLeftoverStep(
				...
				[
					[
						...
						..
						from cell in b
						select new CellViewNode(WellKnownColorIdentifier.Auxiliary1, cell) { RenderingMode = BothDirectAndPencilmark },
						..
						from cell in c
