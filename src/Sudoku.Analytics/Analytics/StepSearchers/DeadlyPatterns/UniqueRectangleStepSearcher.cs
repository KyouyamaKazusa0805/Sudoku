				...
				for (var j = i + 1; j < length; j++)
				{
					...
					for (var c1 = 0; c1 < 4; c1++)
					{
						...
						if (!arMode && SearchForExtendedUniqueRectangles)
						{
							...
							Check3X1LSL(collected, in grid, ref context, urCells, false, comparer, d1, d2, corner1, in cellsExcluding1CornerCell, index);
							Check3X1USL(collected, in grid, ref context, urCells, false, comparer, d1, d2, corner1, in cellsExcluding1CornerCell, index);
						}
