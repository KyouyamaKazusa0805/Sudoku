...
/// </list>
/// </summary>
[StepSearcher(Technique.JuniorExocet)]
...
#pragma warning disable format
	...
	{
		var s = (int[][])[[3, 4, 5, 6, 7, 8], [0, 1, 2, 6, 7, 8], [0, 1, 2, 3, 4, 5]];
		var b = (int[][])[
...
#pragma warning restore format
	...
	/// </summary>
	[RuntimeIdentifier(RuntimeIdentifier.CheckAdvancedJuniorExocet)]
	...
	)
	{
		...
		for (var i = 1; i <= PopCount((uint)otherDigitsMask); i++)
		{
			...
			{
				var currentDigitsMask = MaskOperations.Create(digits);
				for (var j = 0; j < 2; j++)
				{
					var count = 0;
					for (var k = 0; k < 9; k++)
