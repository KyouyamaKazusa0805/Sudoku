...
public enum SingleSubtype
{
	...
	/// </summary>
	[RelatedTechnique(Technique.FullHouse)]
	FullHouseBlock,
	...
	/// </summary>
	[RelatedTechnique(Technique.LastDigit)]
	LastDigit,

	/// <summary>
	/// Indicates the subtype is Hidden Single in Block, with no excluder values.
	/// </summary>
	[RelatedTechnique(Technique.CrosshatchingBlock)]
	...
	/// </summary>
	[RelatedTechnique(Technique.CrosshatchingRow)]
	RowHiddenSingle000,
	...
	/// </summary>
	[RelatedTechnique(Technique.CrosshatchingColumn)]
	...
	/// </summary>
	[RelatedTechnique(Technique.NakedSingle)]
	NakedSingle0,
