...
public sealed partial class HiddenBivalueUniversalGraveType3Step(
...
) : HiddenBivalueUniversalGraveStep(conclusions, views, options), IPatternType3StepTrait<BivalueUniversalGraveType3Step>
{
	/// <inheritdoc/>
	...
	/// <inheritdoc/>
	public override Technique Code => Technique.HiddenBivalueUniversalGraveType3;
	...
	public override FactorArray Factors
		=> [
			Factor.Create(
				"Factor_HiddenBivalueUniversalGraveSubsetSizeFactor",
				[nameof(IPatternType3StepTrait<BivalueUniversalGraveType3Step>.SubsetSize)],
				GetType(),
				static args => (int)args![0]!
			),
			Factor.Create(
				"Factor_HiddenBivalueUniversalGraveSubsetIsHiddenFactor",
