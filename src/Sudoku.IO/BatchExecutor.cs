...
namespace Sudoku.IO
{
	...
	/// <list type="table">
	/// <item>
	/// <term><c>Create workspace with width <![CDATA[<width>]]> height <![CDATA[<height>]]></c></term>
	/// <description>
	/// Create an empty and new picture workspace with the specified width and height.
	/// </description>
	/// </item>
	/// <item>
	/// <term><c>Fill given <![CDATA[<digit>]]> in <![CDATA[<cell>]]></c></term>
	/// <description>Draw a specified given in a specified cell.</description>
	/// </item>
	/// <item>
	/// <term><c>Fill modifiable <![CDATA[<digit>]]> in <![CDATA[<cell>]]></c></term>
	/// <description>Draw a specified modifiable in a specified cell.</description>
	/// </item>
	/// <item>
	/// <term><c>Fill candidate <![CDATA[<digit>]]> in <![CDATA[<cell>]]></c></term>
	/// <description>Draw a specified candidate in a specified cell.</description>
	/// </item>
	/// <item>
	/// <term>
	/// <c>
	/// Draw cell <![CDATA[<cell>]]> with color
	/// a <![CDATA[<a>]]> r <![CDATA[<r>]]> g <![CDATA[<g>]]> b <![CDATA[<b>]]></c>
	/// </term>
	...
	/// <term>
	/// <c>
	/// Draw candidate <![CDATA[<cell>]]> with color
	/// a <![CDATA[<a>]]> r <![CDATA[<r>]]> g <![CDATA[<g>]]> b <![CDATA[<b>]]>
	/// </c>
	/// </term>
	...
	/// <term>
	/// <c>
	/// Draw region <![CDATA[<region>]]> with color
	/// a <![CDATA[<a>]]> r <![CDATA[<r>]]> g <![CDATA[<g>]]> b <![CDATA[<b>]]>
	/// </c>
	/// </term>
	...
	/// <term>
	/// <c>
	/// Draw column <![CDATA[<column>]]> with color
	/// a <![CDATA[<a>]]> r <![CDATA[<r>]]> g <![CDATA[<g>]]> b <![CDATA[<b>]]>
	/// </c>
	/// </term>
	...
	/// <term>
	/// <c>
	/// Draw block <![CDATA[<block>]]> with color
	/// a <![CDATA[<a>]]> r <![CDATA[<r>]]> g <![CDATA[<g>]]> b <![CDATA[<b>]]>
	/// </c>
	/// </term>
	...
	/// <item>
	/// <term>
	/// <c>Draw chain from <![CDATA[<candidate1>]]> to <![CDATA[<candidate2>]]> type (line|strong|weak|chain)</c>
	/// </term>
	/// <description>Draw a chain.</description>
	/// </item>
	/// <item>
	/// <term>
	/// <c>Draw cross <![CDATA[<cell>]]></c>
	/// </term>
	/// <description>Draw a cross sign (used for direct lines).</description>
	/// </item>
	/// <item>
	/// <term>
	/// <c>Draw circle <![CDATA[<cell>]]></c>
	/// </term>
	/// <description>Draw a circle sign (used for direct lines).</description>
	/// </item>
	/// <item>
	/// <term><c>Save to <![CDATA[<path>]]></c></term>
	/// <description>
