...
public sealed partial record LogicalSolver : IAnalyzer<LogicalSolver, LogicalSolverResult>
{
	/// <summary>
	...
	/// <inheritdoc/>
	public LogicalSolverResult Analyze(scoped in Grid puzzle, IProgress<double>? progress = null, CancellationToken cancellationToken = default)
	{
