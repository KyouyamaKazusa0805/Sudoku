...
public interface IUniqueRectangleStepSearcher : IDeadlyPatternStepSearcher
{
	...
	protected internal static bool CheckPreconditions(scoped in Grid grid, int[] urCells, bool arMode)
	{
	...
	protected internal static bool CheckPreconditionsOnIncomplete(scoped in Grid grid, int[] urCells, int d1, int d2)
	{
	...
	protected internal static bool IsConjugatePair(int digit, scoped in CellMap map, int houseIndex)
	...
	/// </exception>
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	protected internal static int GetDiagonalCell(int[] urCells, int cell)
	...
	/// </returns>
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	protected internal static bool IsSameHouseCell(int cell1, int cell2, out int houses)
	{
	...
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	protected internal static IEnumerable<CellViewNode> GetHighlightCells(int[] urCells)
		=> new CellViewNode[]
		{
