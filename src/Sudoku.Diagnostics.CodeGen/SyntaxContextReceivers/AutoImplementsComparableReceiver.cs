...
/// <see cref="AutoImplementsComparableGenerator"/>.
/// </summary>
/// <param name="CancellationToken">The cancellation token to cancel the operation.</param>
/// <seealso cref="AutoImplementsComparableGenerator"/>
internal sealed record class AutoImplementsComparableReceiver(CancellationToken CancellationToken) :
