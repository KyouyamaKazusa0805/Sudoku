...
public sealed partial class AutoImplementsEnumerableGenerator
{
	/// <summary>
	...
	private sealed record class Receiver(CancellationToken CancellationToken) : ISyntaxContextReceiver
	{
		...
		{
			const string attributeFullName = "System.Diagnostics.CodeGen.AutoImplementsEnumerableAttribute";
