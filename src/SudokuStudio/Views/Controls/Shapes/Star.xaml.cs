...
[DependencyProperty<Brush>("Stroke", DocSummary = "Indicates the stroke color for the star.")]
[DependencyProperty<Brush>("Fill", DocSummary = "Indicates the fill color for the star.")]
