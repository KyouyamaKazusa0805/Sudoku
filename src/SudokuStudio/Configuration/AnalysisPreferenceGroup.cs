...
[DependencyProperty<bool>(SettingItemNames.AllowCollisionOnAlmostLockedSetWWing, DefaultValue = true, DocReferencedMemberName = $"global::Sudoku.Analytics.StepSearchers.{nameof(AlmostLockedSetsWWingStepSearcher)}.{nameof(AlmostLockedSetsWWingStepSearcher.AllowCollision)}")]
[DependencyProperty<bool>(AnalyzerSettingItemNames.LogicalSolverIsFullApplying, DocReferencedMemberName = $"global::Sudoku.Analytics.{nameof(Analyzer)}.{nameof(Analyzer.IsFullApplying)}")]
[DependencyProperty<bool>(AnalyzerSettingItemNames.LogicalSolverIgnoresSlowAlgorithms, DocReferencedMemberName = $"global::Sudoku.Analytics.{nameof(Analyzer)}.{nameof(Analyzer.IgnoreSlowAlgorithms)}")]
[DependencyProperty<bool>(AnalyzerSettingItemNames.LogicalSolverIgnoresHighAllocationAlgorithms, DocReferencedMemberName = $"global::Sudoku.Analytics.{nameof(Analyzer)}.{nameof(Analyzer.IgnoreHighAllocationAlgorithms)}")]
...
[DependencyProperty<int>(AnalyzerSettingItemNames.StepGathererMaxStepsGathered, DefaultValue = 1000, DocReferencedMemberName = $"global::Sudoku.Analytics.{nameof(Collector)}.{nameof(Collector.MaxStepsGathered)}")]
[DependencyProperty<int>(AnalyzerSettingItemNames.DifficultyLevelMode, DefaultValue = 0, DocReferencedMemberName = $"global::Sudoku.Analytics.{nameof(Collector)}.{nameof(Collector.DifficultyLevelMode)}")]
[DependencyProperty<List<Technique>>(AnalyzerSettingItemNames.IttoryuSupportedTechniques, DocReferencedMemberName = $"global::Sudoku.Algorithms.Ittoryu.{nameof(DisorderedIttoryuFinder)}.{nameof(DisorderedIttoryuFinder.SupportedTechniques)}")]
