...
[DependencyProperty<int>(RuntimeIdentifier.DirectNakedSubsetMaxSize, DefaultValue = 2, DocReferencedMemberName = $"global::Sudoku.Analytics.StepSearchers.{nameof(DirectSubsetStepSearcher)}.{nameof(DirectSubsetStepSearcher.DirectNakedSubsetMaxSize)}")]
[DependencyProperty<int>(RuntimeIdentifier.DirectHiddenSubsetMaxSize, DefaultValue = 2, DocReferencedMemberName = $"global::Sudoku.Analytics.StepSearchers.{nameof(DirectSubsetStepSearcher)}.{nameof(DirectSubsetStepSearcher.DirectHiddenSubsetMaxSize)}")]
...
[DependencyProperty<List<Technique>>(RuntimeIdentifier.IttoryuSupportedTechniques, DocReferencedMemberName = $"global::Sudoku.Concepts.{nameof(DisorderedIttoryuFinder)}.{nameof(DisorderedIttoryuFinder.SupportedTechniques)}")]
