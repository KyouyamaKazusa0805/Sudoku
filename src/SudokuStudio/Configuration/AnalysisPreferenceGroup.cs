...
[DependencyProperty<bool>(SettingItemNames.AllowCollisionOnAlmostLockedSetsXzRule, DefaultValue = true, DocReferencedMemberName = $"global::Sudoku.Analytics.StepSearchers.{nameof(AlmostLockedSetsXzStepSearcher)}.{nameof(AlmostLockedSetsXzStepSearcher.AllowCollision)}")]
[DependencyProperty<bool>(SettingItemNames.AllowLoopedPatternsOnAlmostLockedSetsXzRule, DefaultValue = true, DocReferencedMemberName = $"global::Sudoku.Analytics.StepSearchers.{nameof(AlmostLockedSetsXzStepSearcher)}.{nameof(AlmostLockedSetsXzStepSearcher.AllowLoopedPatterns)}")]
[DependencyProperty<bool>(SettingItemNames.AllowCollisionOnAlmostLockedSetsXyWing, DefaultValue = true, DocReferencedMemberName = $"global::Sudoku.Analytics.StepSearchers.{nameof(AlmostLockedSetsXyWingStepSearcher)}.{nameof(AlmostLockedSetsXyWingStepSearcher.AllowCollision)}")]
[DependencyProperty<bool>(SettingItemNames.AllowCollisionOnAlmostLockedSetsWWing, DefaultValue = true, DocReferencedMemberName = $"global::Sudoku.Analytics.StepSearchers.{nameof(AlmostLockedSetsWWingStepSearcher)}.{nameof(AlmostLockedSetsWWingStepSearcher.AllowCollision)}")]
...
[DependencyProperty<List<Technique>>(SettingItemNames.IttoryuSupportedTechniques, DocReferencedMemberName = $"global::Sudoku.Algorithms.Ittoryu.{nameof(DisorderedIttoryuFinder)}.{nameof(DisorderedIttoryuFinder.SupportedTechniques)}")]
