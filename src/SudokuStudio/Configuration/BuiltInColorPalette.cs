...
/// </summary>
internal static class BuiltInColorPalette
{
	/// <summary>
	...
	public static readonly IList<Color> Value = new List<Color>
	{
		...
		Color.FromArgb(255, 142, 64, 58),
		Color.FromArgb(255, 58, 6, 3),
		...
		Color.FromArgb(255, 115, 43, 245),
		Color.FromArgb(255, 53, 128, 187),
		Color.FromArgb(255, 0, 2, 61),
		Color.FromArgb(255, 88, 19, 94),
		Color.FromArgb(255, 58, 8, 62),

		Color.FromArgb(255, 161, 251, 142),
		Color.FromArgb(255, 161, 250, 79),
		Color.FromArgb(255, 117, 249, 77),
		Color.FromArgb(255, 117, 250, 97),
		Color.FromArgb(255, 117, 250, 141),
