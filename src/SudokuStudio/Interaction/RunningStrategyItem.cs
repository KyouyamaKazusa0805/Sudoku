...
public sealed partial class RunningStrategyItem([DataMember(SetterExpression = "set")] string titleKey, [DataMember(SetterExpression = "set")] RunningStrategyUpdater updater);
