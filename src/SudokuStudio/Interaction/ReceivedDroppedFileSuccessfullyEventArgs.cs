...
public sealed partial class ReceivedDroppedFileSuccessfullyEventArgs([PrimaryConstructorParameter] string filePath, [PrimaryConstructorParameter] GridInfo gridInfo) : EventArgs;
