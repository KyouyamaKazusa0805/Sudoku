...
/// <summary>
/// Represents a list of identifiers used by renderable items that will be consumed by <see cref="RenderableFactory"/>.
/// </summary>
/// <seealso cref="RenderableFactory"/>
internal static class RenderableItemIdentifiers
{
	/// <summary>
