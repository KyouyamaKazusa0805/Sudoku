...
internal static class RenderableFactory
{
	...
	{
		{ ColorIdentifier.Normal, static () => new CircleRing() },
		{ ColorIdentifier.Auxiliary1, static () => new Cross() },
		{ ColorIdentifier.Auxiliary2, static () => new Triangle() },
		{ ColorIdentifier.Auxiliary3, static () => new Diamond() },
		{ ColorIdentifier.Assignment, static () => new CircleRing() },
		{ ColorIdentifier.OverlappedAssignment, static () => new CircleRing() },
		{ ColorIdentifier.Elimination, static () => new Cross() },
		{ ColorIdentifier.Cannibalism, static () => new Cross() },
		{ ColorIdentifier.Exofin, static () => new Triangle() },
		{ ColorIdentifier.Endofin, static () => new Diamond() },
