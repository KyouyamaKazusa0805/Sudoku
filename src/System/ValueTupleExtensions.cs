...
public static class ValueTupleExtensions
{
	...
	/// <returns>An enumerator instance.</returns>
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public static ValueTupleEnumerator<T> GetEnumerator<T>(this (T, T, T) @this) => new(@this);
	...
	/// <returns>An enumerator instance.</returns>
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public static ValueTupleEnumerator<T> GetEnumerator<T>(this (T, T, T, T) @this) => new(@this);
	...
	/// <returns>An enumerator instance.</returns>
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public static ValueTupleEnumerator<T> GetEnumerator<T>(this (T, T, T, T, T) @this) => new(@this);
	...
	/// <returns>An enumerator instance.</returns>
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public static ValueTupleEnumerator<T> GetEnumerator<T>(this (T, T, T, T, T, T) @this) => new(@this);
	...
	/// <returns>An enumerator instance.</returns>
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public static ValueTupleEnumerator<T> GetEnumerator<T>(this (T, T, T, T, T, T, T) @this) => new(@this);
	...
	/// <returns>An enumerator instance.</returns>
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public static ComplexValueTupleEnumerator<T, TRest> GetEnumerator<T, TRest>(this ValueTuple<T, T, T, T, T, T, T, TRest> @this)
		where TRest : struct
		=> new(@this);
}
