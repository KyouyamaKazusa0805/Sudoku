	...
	public static class MarkdownExtensions
	{
			...
			this ref ValueStringBuilder @this, string text, bool appendPaddingSpaces)
		{
			...
			switch ((text.Contains(MarkdownSymbols.InlineCodeBlockStartSingle), appendPaddingSpaces))
			{
				...
				{
					@this.Append(' ');
					@this.Append(MarkdownSymbols.InlineCodeBlockStartDouble);
					@this.Append(text);
					@this.Append(MarkdownSymbols.InlineCodeBlockEndDouble);
					@this.Append(' ');
				...
				{
					@this.Append(' ');
					@this.Append(MarkdownSymbols.InlineCodeBlockStartSingle);
					@this.Append(text);
					@this.Append(MarkdownSymbols.InlineCodeBlockEndSingle);
					@this.Append(' ');
		...
		{
			@this.Append(MarkdownSymbols.CodeBlockStart);
			@this.Append(codelang ?? string.Empty);
			@this.AppendLine();
			@this.Append(code);
			@this.AppendLine();
			@this.Append(MarkdownSymbols.CodeBlockEnd);
			@this.AppendLine();
			@this.AppendLine();
		}
		...
		public static void AppendHeaderText(this ref ValueStringBuilder @this, string text)
		{
			...
			@this.Append(MarkdownSymbols.H1);
			@this.Append(text);
			@this.AppendLine();
			@this.AppendLine();
		}
