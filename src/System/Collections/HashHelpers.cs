	...
	public static uint FastMod(uint value, uint divisor, ulong multiplier)
	{
		...
		if (divisor > int.MaxValue)
		{
			throw new ArgumentException(
				"The divisor can't be greater than 'int.MaxValue' even though it's an uint value.",
				nameof(divisor)
			);
		}
		...
		{
			throw new ArithmeticException("The operation gets something wrong to handle.");
		}
