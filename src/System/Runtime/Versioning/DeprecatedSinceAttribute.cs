...
/// <summary>
/// Represents an attribute type that describes the beginning version that is deprecated this API.
/// </summary>
...
[AttributeUsage(
	...
	Inherited = false)]
public sealed class DeprecatedSinceAttribute(int major, int minor, int build = -1, int revision = -1) :
