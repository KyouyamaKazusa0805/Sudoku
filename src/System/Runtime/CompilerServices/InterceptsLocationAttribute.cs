...
public sealed partial class InterceptsLocationAttribute([RecordParameter] string filePath, [RecordParameter] int line, [RecordParameter] int character) : Attribute;
