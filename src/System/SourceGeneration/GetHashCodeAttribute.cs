...
public sealed partial class GetHashCodeAttribute([RecordParameter] GetHashCodeBehavior behavior = GetHashCodeBehavior.Intelligent) : PatternOverriddenAttribute;
