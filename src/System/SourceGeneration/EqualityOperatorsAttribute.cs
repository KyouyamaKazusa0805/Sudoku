...
public sealed partial class EqualityOperatorsAttribute([PrimaryConstructorParameter] EqualityOperatorsBehavior behavior = EqualityOperatorsBehavior.Intelligent) : DuckTypingAttribute;
