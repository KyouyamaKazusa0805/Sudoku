...
extern const int perm[6][3] = { {0,1,2},{0,2,1},{1,0,2},{1,2,0},{2,0,1},{2,1,0} };

extern const int minCanNineBits[512] = { //a precomputed minlexed recomposition of the bit triplets for a 9-bits input
...
extern const BestTripletPermutation bestTripletPermutations[8][64] = {
	{
