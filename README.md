...
* Chains: X-Chain, X-Cycle (Fishy Cycle), XY-Chain, XY-Loop (XY-Cycle), Discontinuous Nice Loop, XY-X-Chain, Alternating Inference Chain, Continuous Nice Loop, AIC | CNL with Locked Candidates<br/>链：同数链、同数环、双值格链、双值格环、不连续环、首尾异数链、普通链、环、普通链和环带区块
