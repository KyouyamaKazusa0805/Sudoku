...
namespace Sudoku.Data.Meta
{
	internal sealed class GridFormatter
	{
		...
		private string ToMultiLineStringCore()
		{
			...
			{
				[0] = new List<short>(), [1] = new List<short>(), [2] = new List<short>(),
				[3] = new List<short>(), [4] = new List<short>(), [5] = new List<short>(),
				[6] = new List<short>(), [7] = new List<short>(), [8] = new List<short>()
			};
