...
* 致命结构（Uniqueness）
  * 唯一矩形（Unique Rectangle，UR）
    ...
    * 唯一矩形 + 结构
      ...
      * 唯一矩形 + 袋鼠（Unique Rectangle Unknown Covering，UR-Unknown Covering）
...
* 待定数组（Almost Locked Sets，ALS）
  ...
  * 融合待定数组（Sue de Coq，SdC）
    * 标准融合待定数组
    * 自噬融合待定数组（Cannibalistic Sue de Coq，Cannibalistic SdC）
...
* [经典回溯](https://github.com/SunnieShine/Sudoku/blob/main/src/Sudoku.Solving/Solving/BruteForces/BacktrackingSolver.cs)（Backtracking）
* [LINQ 算法](https://github.com/SunnieShine/Sudoku/blob/main/src/Sudoku.Solving/Solving/BruteForces/OneLineLinqSolver.cs)（LINQing）
* [周运栋位运算算法](https://github.com/SunnieShine/Sudoku/blob/main/src/Sudoku.Solving/Solving/BruteForces/FastSolver.cs)（Zhou's Bitwise Algorithm）