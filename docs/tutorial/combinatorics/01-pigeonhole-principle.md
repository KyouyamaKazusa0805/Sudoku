...
其中 $$h$$$$\hbar$$（读作“h bar”）是量子力学中的约化普朗克常数。普朗克常数记作 $$h$$，而这个约化普朗克常数 $$\hbar$$ 等于 $$\frac{h}{2\pi}$$。总之就还是一个常量。如果你对量子力学感兴趣，可以看看[这个式子的证明](https://en.wikipedia.org/wiki/Uncertainty_principle#Proof_of_the_Kennard_inequality_using_wave_mechanics)。
