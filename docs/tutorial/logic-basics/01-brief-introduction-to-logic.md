...
可从上面的描述看出，大体似乎都没啥毛病。但是**在逻辑学里，只有互为逆否的命题的真假性才等价**。什么意思呢？意思就是说，**原命题和逆否命题同真假性，逆命题和否命题同真假性**。
...
这个问题解释起来有些复杂。我们把他具象化为一个实际例子给各位解释一下。假设我说两个命题 $$P$$ 和 $$Q$$ 分别代指的是“我考到驾照了”和“我带你去兜风”。也就是说 $$P \to Q$$ 指的是“如果我考到驾照了，我就带你兜风”。
