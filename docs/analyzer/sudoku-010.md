...
```csharp
Current.ChangeLanguage(param); // OK.
Current.Serialize(param1, param2); // OK
Current.Deserialize(param1, param2); // OK
Current.GreetWith(param); // Wrong.
Current.DoSomething(param); // Wrong.
```